...
class Stats extends ResourceController
{
  ...
  public function index()
  {
    ...
    $queryObj = ['totals' => $query->getResultArray()];
    ...
    $query3 = $db->query('SELECT CONCAT(name, " ", last_name) AS name, date_created, date_modified FROM users ORDER BY date_modified DESC LIMIT 3');
